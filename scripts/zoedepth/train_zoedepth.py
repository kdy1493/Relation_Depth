#!/usr/bin/env python3
"""Launch ZoeDepth fine-tuning from a YAML config.

Requires upstream ZoeDepth under ``src/zoedepth/vendor``. Clone once:
...
try:
    from zoedepth.train import main
